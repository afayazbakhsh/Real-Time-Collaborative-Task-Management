...
return [
    ...
    */
    ...
    'boolean' => 'فیلد :attribute فقط می‌تواند بله و یا خیر باشد.',
    ...
    'dimensions' => 'ابعاد تصویر :attribute باید حداکثر عرض :max_width و حداکثر ارتفاع :max_height باشد.',
    ...
    'my_enum' => ':attribute انتخاب شده، معتبر نیست.',
    ...
    'password' => [
        'letters' => ':attribute باید شامل حروف و عدد باشد',
        'mixed' => ':attribute باید شامل حروف بزرگ و کوچک و عدد باشد',
        'numbers' => ':attribute باید شامل عدد باشد',
        'symbols' => ':attribute باید شامل کاراکتر های سیمبلیک باشد.',
        'uncompromised' => ':attribute انتخاب شده ضعیف میباشد :attribute قوی تری انتخاب کنید',
    ],
    ...
    'prohibited_if' => 'در صورت وجود فیلد :other، فیلد :attribute ممنوع است.',
    'prohibited_unless' => ':attribute مجاز نمی‌باشد مگر اینکه :other یکی از :values باشد.',
    ...
    'prohibits' => 'در صورت وجود فیلد :attribute فیلد :other نباید وجود داشته باشد',
    'extensions' => ':attribute باید مطابق با فرمت های موجود باشد: :values',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    | with something more reader friendly such as E-ParentMail Address instead
